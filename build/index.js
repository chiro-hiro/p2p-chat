...
console.log("Service online:", node.getMultiaddrs().map((e) => e.toString()));
...
node.services.pubsub.addEventListener("message", (message) => {
    if (message.detail.topic === TOPIC) {
        ...
        console.log(`${chalk.bgBlue.white(res.time)}${chalk.bgGreen.white(res.from)}${chalk.bgRed.white(res.message)}`);
    }
});
